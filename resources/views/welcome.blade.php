    ...
    <div>
                    ...
                    <div class="card h-100">
                        <div id="carouselExampleIndicators{{$key}}" class="carousel slide" data-ride="carousel">
                            <div class="carousel-inner">
                                @if($post->postImages->count() <= 0) <div class="carousel-item active">
                                    <img class="d-block w-100" src="http://placehold.it/700x400?auto=yes&bg=777&fg=555&text=No images to display" alt="First slide" height="200px" width="100px">
                            </div>
                            @endif
                            @foreach($post->postImages as $image)
                            <div class="carousel-item {{$image->id == $post->postImages[0]->id ? 'active': ''}}">
                                <img class="d-block w-100" src="data:image/jpeg;base64,{{$image->image_data}}" alt="{{$post->name}}" height="200px" width="100px">
                            </div>
                            @endforeach
                        </div>
        ...
        <div class="row mt-5">
            <div class="col-md-8 mb-5">
                <h2>What We Do</h2>
                <hr>
                <p>We are an award-winning marketplace for unique and authentic stays. We are the fastest growing stay listing in Colombo. All stays are powered by locals. Experience the true hospitality of Sri Lankans while you are travelling to Sri Lanka.!</p>
            </div>
